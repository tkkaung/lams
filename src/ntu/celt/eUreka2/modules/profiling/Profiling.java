...
public class Profiling implements Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4734531592919306789L;
	@NonVisual
	private long id;
	private String name; 
	...
	private LQuestionSet questionSet;		//just for reference, because criterias is loaded from this
	private String questionSetName;
	private List<ProfileQuestion> questions = new ArrayList<ProfileQuestion>();
	private Set<ProfileUser> profUsers = new HashSet<ProfileUser>();
	private Group group;
	...
	public Profiling(String name, Project proj, User creator, int orderNumber, LQuestionType questionType, Date cdate){
		super();
		id =  Util.generateLongID();
		this.name = name;
		this.project = proj;
	...
	public void setQuestions(List<ProfileQuestion> questions) {
		this.questions = questions;
	}
	public void addQuestions(ProfileQuestion question){
		questions.add(question);
	}
	public void removeQuestions(ProfileQuestion question){
	...
	public Set<ProfileUser> getProfUsers() {
		return profUsers;
	}
	public void setProfUsers(Set<ProfileUser> profUsers) {
		this.profUsers = profUsers;
	}
	
	public void addProfUsers(ProfileUser profUser){
		profUsers.add(profUser);
	}
	public void removeProfUsers(ProfileUser profUser){
		profUsers.remove(profUser);
	}
	...
	public boolean isPeerProfiling(){
		if(this.questionType == LQuestionType.PEER)
			return true;
		return false;
	}
	public boolean isInstructorProfiling(){
		if(this.questionType == LQuestionType.INSTRUCTOR)
			return true;
		return false;
	}
