...
public class CAREQuestion {
	...
	public CAREQuestion(String des, Integer number, String[] dims ) {
		super();
		id =  Util.generateLongID();
		this.des = des;
		this.number = number;
	...
	public CAREQuestion createCopy(){
		String dims[] = {dimension1, dimension2, dimension3, dimension4, dimension5, dimension6, dimension7, 
				dimension8, dimension9, dimension10, dimension11, dimension12, dimension13, dimension14, dimension15 };
		return new CAREQuestion(this.des, this.number, dims);
	}
