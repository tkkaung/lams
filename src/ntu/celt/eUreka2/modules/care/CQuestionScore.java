...
public class CQuestionScore {
	...
	private CARESurveyUser careUser; //reference back
	private Integer orderNum;
	
	public static final int MAX_SCORE = 5;

	
	public CQuestionScore(){
		super();
		id =  Util.generateUUID();
	}
	
	public CQuestionScore(CAREQuestion question, int score, int score1, int score2,
			int score3, int score4, int score5, int score6, int score7,
			int score8, int score9, int score10, int score11, int score12,
			int score13, int score14, int score15, CARESurveyUser careUser,
			Integer orderNum) {
		super();
		id =  Util.generateUUID();
	...
	public CQuestionScore(CAREQuestion question, int score, int[] scores, CARESurveyUser careUser,
			Integer orderNum) {
		super();
		id =  Util.generateUUID();
		this.question = question;
	...
	public CAREQuestion getQuestion() {
		return question;
	}
	public void setQuestion(CAREQuestion question) {
		this.question = question;
	}

	public void setCareUser(CARESurveyUser careUser) {
		this.careUser = careUser;
	}

	public CARESurveyUser getCareUser() {
		return careUser;
	}
