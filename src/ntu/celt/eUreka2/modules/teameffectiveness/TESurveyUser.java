...
public class TESurveyUser {
	...
	private Set<TEQuestionScore> questionScores = new HashSet<TEQuestionScore>();
	...
	public TESurvey getSurvey() {
		return survey;
	}
	public void setSurvey(TESurvey survey) {
		this.survey = survey;
	}
	public void setQuestionScores(Set<TEQuestionScore> questionScores) {
		this.questionScores = questionScores;
	}
	public Set<TEQuestionScore> getQuestionScores() {
		return questionScores;
	}
	public void addQuestionScore(TEQuestionScore qs){
		this.questionScores.add(qs);
	}
	public void removeQuestionScore(TEQuestionScore qs){
