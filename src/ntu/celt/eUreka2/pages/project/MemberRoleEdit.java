...
public class MemberRoleEdit extends AbstractPageProject{
	@Property
	...
	Object onSuccessFromForm(){
		...
		if(notifyMember){
			EmailTemplateVariables var = new EmailTemplateVariables(
					...
					Util.nvl(pUser.getCustomRoleName()));
		...
		return linkSource.createPageRenderLinkWithContext(ManageMember.class, curProj.getId()); 
