...
public class EditSchAnnmt extends AbstractSchlTypeAnnouncement{
	@Property
	private SchlTypeAnnouncement _annmt;
	private int _id = 0; 
	private List<Integer> accessibleSchlIDs;
    ...
    public String getTitle(){
    	if(isCreateMode())
    		return _messages.get("add-new")+" "+_messages.get("schoolannouncement");
    	return _messages.get("edit")+" "+_messages.get("schoolannouncement");
    }
    ...
    void setupRender() {
		...
		accessibleSchlIDs = getAccessibleSchlIDs(getCurUser());
