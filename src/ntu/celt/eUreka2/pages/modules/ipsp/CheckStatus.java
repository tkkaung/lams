...
public class CheckStatus extends AbstractPageIPSP{
	@Property
	...
	void onActivate(long id) {
		...
		ipsp = eDAO.getIPSPSurveyById(eid);
		if(ipsp==null)
			throw new RecordNotFoundException(messages.format("entity-not-exists", "IPSP ID", eid));
		project = ipsp.getProject();
		assessors = getNotSubmitedAssesseesByIPSPSurvey(ipsp); 
	}
	long onPassivate() {
		return eid;
	}
