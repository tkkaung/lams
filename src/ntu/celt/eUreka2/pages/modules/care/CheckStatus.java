...
public class CheckStatus extends AbstractPageCARE{
	@Property
	...
	void onActivate(long id) {
		...
		care = eDAO.getCARESurveyById(eid);
		if(care==null)
			throw new RecordNotFoundException(messages.format("entity-not-exists", "CARE ID", eid));
		project = care.getProject();
		assessors = getNotSubmitedAssesseesByCARESurvey(care); 
	}
	long onPassivate() {
		return eid;
	}
