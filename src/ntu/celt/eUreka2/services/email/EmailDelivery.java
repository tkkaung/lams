 ...
 *
 * @author  Tim Archer 09/30/2003 , edited by Somsak Jangdaboud
...
public class EmailDelivery {
   // static Logger log = Logger.getLogger(EmailDelivery.class);
    ...
    private String smtp_host = new String("");
    ...
    private String smtp_sendPartial = "true";
    ...
    public void setSMTPHost(String p_host) throws MessagingException {
        this.setSMTPHost(p_host, null, null, smtp_sendPartial);
    }
     ...
     *
     */      
    public void setSMTPHost(String p_host, String p_username, String p_password, String smtp_sendPartial) throws MessagingException {
   //     log.debug("EmailDelivery in setSMTPHost Method. Host: "+p_host+" Username: "+p_username);
        ...
        props.put("mail.smtp.sendpartial", smtp_sendPartial);
   ...
   //     log.debug("EmailDelivery in setSMTPHost Method. UsingAuthenticaton: "+usingAuthentication);
     ...
     *
     */      
    public void setSMTPPort(int p_port)  {
        smtp_port = p_port;
    ...
    public void setBodyHTML(String p_body) throws MessagingException {
    	msg.setContent(p_body, "text/html");
    }
  ...
  //      log.debug(logMsg);
    ...
    public void sendMsgHTML() throws MessagingException {
        //
        // set the Date: header
        //
        msg.setSentDate(new Date());
...
//            log.debug("Preparing to send email.");
            ...
            ed.setTo("kuafong@hotmail.com, soms0001@ntu.edu.sg");
            ed.setCC("somsakjang@gmail.com.com");
            ed.setBCC("somsak_jang@yahoo.com");
            ed.setFrom("somsakjang@gmail.com");
